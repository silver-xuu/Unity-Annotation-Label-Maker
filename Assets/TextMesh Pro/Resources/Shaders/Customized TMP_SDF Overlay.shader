Shader "TextMeshPro/Customize Distance Field Overlay" {
...
Properties {
	...
	_OverlayColor		("Face Overlay Color", Color) = (1,1,1,0.3)
...
CustomEditor "TMPro.Editor
Utilities.TMP_SDFShaderGUI"
}
